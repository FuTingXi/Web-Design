...
// 图片数组，包含多个对象，每个对象代表一张图片，包括图片的URL和路径
let imgArr = [{
    url: '#',
...
{
    url: '#',
    imgPath: './images/05.jpg'
}
];

// 创建一个名为 Swiper 的新对象，并传入配置参数
new Swiper({
imgArr: imgArr,       // 图片数组，包含图片的URL和路径
imgWidth: 320,        // 图片宽度
aniTime: 1000,        // 动画过渡时间
intervalTime: 150,   // 图片切换间隔时间
scale: 0.8,           // 图片缩放比例
autoplay: true,      // 是否自动播放
gap: -200,            // 图片间距
clsSuffix: '-stack'   // 类名后缀
}).init();               // 执行初始化方法